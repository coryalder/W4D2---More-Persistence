...
- (void)insertNewObject:(id)sender {
    ...
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"New Club" message:@"Enter the name of your club" preferredStyle:UIAlertControllerStyleAlert];
    ...
    [alert addAction:[UIAlertAction actionWithTitle:@"Save" style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
        ...
        Club *newClub = [NSEntityDescription insertNewObjectForEntityForName:[entity name] inManagedObjectContext:context];
